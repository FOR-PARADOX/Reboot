...
namespace RuriLib
{
    ...
    public class ConfigSettings : ViewModelBase
    {
        ...
        public string KeysDB { get { return keysdb; } set { keysdb = value; OnPropertyChanged(); } }

        private string localkeysdb = "";
        public string LocalKeysDB { get { return localkeysdb; } set { localkeysdb = value; OnPropertyChanged(); } }

        public bool isWtoEdit { get; set; }

        public string CreatorLK = ConfigViewModel.getLoliKey();
        ...
        private string version = "1.2.2.6";
