    ...
    public partial class PageBlockFunction : Page
    {
        ...
        private void functionTypeCombobox_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            switch (vm.FunctionType)
            {
                ...
                case BlockFunction.Function.AESEncryptCBC:
                    functionTabControl.SelectedIndex = 12;
                    break;

                case BlockFunction.Function.AESDecryptCBC:
                    functionTabControl.SelectedIndex = 12;
                    break;
            }
        }
        ...
        public Dictionary<string, string> infoDic = new Dictionary<string, string>()
        {
            ...
            { "AESEncryptCBC", "Using SHA256, the most commonly used along with AES with CBC as CipherMode" },
            { "AESDecryptCBC", "Using SHA256, the most commonly used along with AES with CBC as CipherMode" }
        };
